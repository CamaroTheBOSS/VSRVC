...
def load_model(json_file):
    ...
    class IFrameModel(architecture, weighting):
    ...
    class PFrameModel(architecture, weighting):
        def __init__(self, task_name, encoder_class, decoders, rep_grad, multi_input, device, lmbda, kwargs):
    ...
    if model_type == "IFrame":
        ...
        raise ValueError("Unrecognized model_type. Supported are ['IFrame', 'PFrame']")

    strict = False if model_type == "PFrame" else True
